    ...
    return (
        <div className="relative">
            <button
                ...
                title={isOnline ? "Connected - Click for details" : "Offline - Click for details"}
            >
                ...
                <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-64 p-4 bg-bg-secondary rounded-xl border border-border-light shadow-xl z-50 animate-in fade-in slide-in-from-top-2">
                        <h3 className="text-sm font-semibold text-text-primary mb-3 flex items-center gap-2">
                            <span className="text-accent-purple">🔥</span> Firebase Status
                        </h3>
                        ...
                        <div className="space-y-3 text-xs">
                            ...
                            <div className="space-y-1">
                                <span className="text-text-muted block text-[10px] uppercase tracking-wider">Project ID</span>
                            ...
                            <div className="space-y-1">
                                <span className="text-text-muted block text-[10px] uppercase tracking-wider">Auth Domain</span>
                                <span className="text-text-primary font-mono bg-bg-tertiary px-2 py-1 rounded block truncate">
                            ...
                            <div className="space-y-1">
                                <span className="text-text-muted block text-[10px] uppercase tracking-wider">API Key</span>
                                <span className="text-text-primary font-mono bg-bg-tertiary px-2 py-1 rounded block truncate">
                                    {maskedApiKey}
                                </span>
                            </div>
